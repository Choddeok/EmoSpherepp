...
from models.tts.EmoSphere2_ort_mlp.base import BaseModule
from models.tts.EmoSphere2_ort_mlp.text_encoder import TextEncoder
from models.tts.EmoSphere2_ort_mlp.flow_matching import CFM
from models.tts.EmoSphere2_ort_mlp.utils import (
    sequence_mask,
    generate_path,
    duration_loss,
...
class EmoSphere2_ort(BaseModule):
    def __init__(self, dict_size, hparams, out_dims=80):
        super(EmoSphere2_ort, self).__init__()
